...
double distance = 10000;                                           //стартовое расстояние между друзьями 10000м
double firstFriendSpeed = 1;                                       //Скорость первого друга 1м/с
double secondFriendSpeed = 1.2;                                      //Скорость второго друга 2м/с
double dogSpeed = 2.4;                                               //Скорость собаки 4м/с
double time = 0;                                                   //Стартовое время 0с
